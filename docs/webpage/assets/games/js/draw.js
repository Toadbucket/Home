// js/draw.js
import { canvas, ctx, cellSize, gridSize, tileColors } from "/docs/webpage/assets/games/js/config.js";
import { selectedTiles } from "/docs/webpage/assets/games/js/controls.js";

let imageLoaded = false;
const tileImg = new Image();
tileImg.src = "/docs/webpage/assets/media/tile.png"; // match monolithic path
